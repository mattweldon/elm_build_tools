...
var _user$project$View$helloWorld = A2(
	_elm_lang$html$Html$h1,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('Hello World from Chokidar CLI.')
		]));

var _user$project$Main$main = {main: _user$project$View$helloWorld};
